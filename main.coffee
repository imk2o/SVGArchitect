...
isClickableElement = (element) ->
  ...
  return clickable_elements[element.tagName]?
...
$(function(){    // body onload
    ...
    function clearSelection() {
        $("#svg_tree").dynatree("getRoot").visit(function(node){ node.select(false); });
    }
    ...
    $('#remove').click(function() {
        var selected_nodes = $('#svg_tree').dynatree('getSelectedNodes');
